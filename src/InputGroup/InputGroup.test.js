...
describe('<InputGroup />', () => {
    ...
    describe('Callback handling', () => {
        test('should dispatch the onUpClicked callback with the event', () => {
            let f = jest.fn();
            const element = mount(<InputGroup inputProps={{ 'data-sample': 'Sample' }} inputType='number'
                onUpClicked={f} />);

            element.find('.fd-input-group__button--step-up').simulate('click');

            expect(f).toHaveBeenCalledTimes(1);
        });
        test('should dispatch the onDownClicked callback with the event', () => {
            let f = jest.fn();
            const element = mount(<InputGroup inputProps={{ 'data-sample': 'Sample' }} inputType='number'
                onDownClicked={f} />);

            element.find('.fd-input-group__button--step-down').simulate('click');

            expect(f).toHaveBeenCalledTimes(1);
        });
        test('should dispatch the onClearClicked callback with the event', () => {
            let f = jest.fn();
            const element = mount(<InputGroup inputProps={{ 'data-sample': 'Sample' }} inputType='search'
                onClearClicked={f} />);

            element.find('.fd-input-group__button--clear').simulate('click');
        ...
        test('should dispatch the onSearchInputChange callback with the event', () => {
            let f = jest.fn();
            const element = mount(<InputGroup inputProps={{ 'data-sample': 'Sample' }} inputType='search'
        ...
        test('should dispatch the onTextChange callback with the event', () => {
            let f = jest.fn();
            const element = mount(<InputGroup inputProps={{ 'data-sample': 'Sample' }} inputType='text'
                onTextChange={f} />);
