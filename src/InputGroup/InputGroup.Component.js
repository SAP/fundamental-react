...
<FormGroup>
    ...
    return (
        <div>
            ...
            <Separator />
            <h2>Playground</h2>
            <Playground component="inputgroup" schema= {[
                    {
                        attribute: 'addonPos',
                ...
                <FormGroup>
                    <FormLabel labelText="Input with text action" />
                    <FormItem>
                        <InputGroup inputType="text" addonPos="after" inputValue="1234567890" addon="$" actions={true}>
                            <Button type="secondary" glyph="navigation-down-arrow">Button</Button>
                        </InputGroup>
                    </FormItem>
                </FormGroup>
            </Playground>
