...
<FormGroup>
    ...
    return (
        <div>
            ...
            <Description>
                The input group includes form inputs with add-ons that allow the user to better understand the
            ...
            <Properties
                ...
                properties={[
                    ...
                    { name: 'compact', description: 'bool  - set to true to enable compact mode' }
                ]}
            />
            ...
            <h2>Text add-on</h2>
            <Description>
                The Input with text add-on component is typically used to specify the type of the data being entered,
                such as currency or unit of measure. This add-on can be placed at the left or right of the input
                element.
            </Description>
            <DocsTile>
                <FormGroup>
            ...
            >
                <FormGroup>
                    <FormLabel labelText="Input with text action" />
                    <FormItem>
                        <InputGroup inputType="text" addonPos="after" inputValue="1234567890" addon="$" actions>
                            <Button option="light" glyph="navigation-down-arrow">
                                Button
                            </Button>
                        </InputGroup>
