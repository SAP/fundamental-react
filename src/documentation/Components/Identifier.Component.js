...
<Identifier size="m" glyph="money-bills" color={9}></Identifier>`;
    ...
    return (
        <div>
            ...
            <Import module="Identifier" path="/fundamental-react/src/components/" />
                ...
                properties={[
                    {
                        name: 'size',
                        description:
                            'string - Three sizes are available: s (small) - 24px, m (medium) - 36px, and l  (large) - 48px.'
                    },
                    {
                        name: 'glyph',
                        description:
            ...
            <h2>Transparent</h2>
            <DocsTile centered>
                <Identifier size="m" label="Wendy Wallace" modifier="transparent">
                    WW
                </Identifier>
