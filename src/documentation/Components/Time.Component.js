...
export const TimeComponent = () => {
  ...
  return (
    <div>
      <Header>Time</Header>
      <Description>
        The time component is used for a single time value. Multiple components
        can be used in the time-picker to assemble a clock time. A max of four
        will account for hours, minutes, seconds and period of the day. It will
        be rare to see this component used outside of it being composed in the
        time-picker component.
      </Description>
      <Import module='Time' path='/fundamental-react/src/components/' />
      <Separator />{' '}
      <Properties
        type='Inputs'
        properties={[
      ...
      <Description>
        The Time component can be set to disabled state by setting disabled to
        true
      </Description>
      <DocsTile>
        <Time disabled={true} />
