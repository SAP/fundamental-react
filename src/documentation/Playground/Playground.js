...
export class Playground extends Component {
    ...
    render() {
                        ...
                        <div className="form-group-sublevel" key={item.attribute}>
                            ...
                            {item.enum ? (
                                <select className="form-control" onChange={this.updateComponent} name={item.attribute}>
                                    {item.enum.map(enumItem => <option key={enumItem} value={enumItem}>{enumItem}</option>)}
                                </select>
                            ) : (
                                    <input type="text" className="form-control" value={item.initialValue} onChange={this.updateComponent} name={item.attribute}/>
                                )
                            }
                        </div>
                    )
                    ...
                    return (
                        ...
                        <p>Names</p>
                        {
                            item.enum ? (<div>
                                ...
                                <input type="text" className="form-control" onChange={this.updateListsName} name={enumItem}/>
                                </div>)}
                            </div>) : null
                        }
                        </div>
                    ...
                    return (
                        ...
                        <p>Content</p>
                        {
                            item.enum ? (<div>
                                ...
                                <div>
                                <label>{enumItem}</label>
                                <input type="text" className="form-control" onChange={this.updateListsContent} name={enumItem}/>
                                </div>)}
                            </div>) : null
                        }
                        </div>
                ...
                case 'component':
                    return (
                        <div className="form-group-sublevel" key={item.attribute}>
                            <label>{item.attribute}</label>
                            {item.enum ? (
                                <select className="form-control" onChange={this.updateComponentType} name={item.attribute}>
                                    {item.enum.map(enumItem => <option key={enumItem} value={enumItem}>{enumItem}</option>)}
                                </select>
                            ) : (
                                    <input type="text" className="form-control" value={item.initialValue} onChange={this.updateComponent} name={item.attribute}/>
        ...
        switch (this.props.component) {
            case 'alert':
                componentToGenerate = <Alert type={this.state.childs.type} dismissable={this.state.childs.dismissable} link={this.state.childs.link} linkText={this.state.childs.linkText}>Default alert with a </Alert>;
                break;
            case 'badge':
                if (this.state.childs.component == 'label') {
                    componentToGenerate = <Label type={this.state.childs.type} modifier={this.state.childs.modifier}>{this.state.childs.children}</Label>
                }
                else {
                    componentToGenerate = <Badge type={this.state.childs.type} modifier={this.state.childs.modifier}>{this.state.childs.children}</Badge>
                }
                break;
            case 'button':
                componentToGenerate = <Button type={this.state.childs.type} glyph={this.state.childs.glyph} semantic={this.state.childs.semantic} size={this.state.childs.size} state={this.state.childs.state}>{this.state.childs.children}</Button>
                break;
            case 'buttongroup':
                componentToGenerate = <ButtonGroup>
                <ButtonGrouped size={this.retrieveValue("size",this.state.childs.children[0].props.size, this.state.currentValues)}>Left</ButtonGrouped>
                <ButtonGrouped size={this.retrieveValue("size", this.state.childs.children[1].props.size, this.state.currentValues)} glyph={this.retrieveValue("glyph",this.state.childs.children[1].props.glyph, this.state.currentValues)} state={this.retrieveValue("state", this.state.childs.children[1].props.state, this.state.currentValues)}></ButtonGrouped>
                <ButtonGrouped size={this.retrieveValue("size",this.state.childs.children[2].props.size, this.state.currentValues)}>Right</ButtonGrouped>
                </ButtonGroup>
                break;
            case 'dropdown':
                componentToGenerate = <Dropdown buttonText={this.retrieveValue("buttonText",this.state.childs.buttonText, this.state.currentValues)} buttonIcon={this.retrieveValue("buttonIcon",this.state.childs.buttonIcon, this.state.currentValues)} size={this.retrieveValue("size", this.state.childs.size, this.state.currentValues)} state={this.retrieveValue("state",this.state.childs.state, this.state.currentValues)} isContextual={this.retrieveValue("isContextual", this.state.childs.isContextual, this.state.currentValues)}>
                    <DropdownList links=
                    {this.state.childs.children.props.links}>
                    </DropdownList>
                    </Dropdown>
                break;
            case 'icon':
                ...
                break;
            case 'identifier':
                componentToGenerate = <Identifier size={this.state.childs.size} label={this.state.childs.label} modifier={this.state.childs.modifier} color={this.state.childs.color} glyph={this.retrieveValue("children", "", this.state.currentValues) == "" ? this.state.childs.glyph : null}>{this.retrieveValue("children", this.state.childs.children, this.state.currentValues)}</Identifier>
                break;
            case 'image':
                componentToGenerate = <Image size={this.state.childs.size} type={this.state.childs.type} photo={this.state.childs.photo}></Image>
                break;
            case 'tabs':
                componentToGenerate = 
                <Tabs>
            ...
            case 'inputgroup':
                ...
                <FormItem>
                    <InputGroup inputType={this.state.childs.children[1].props.children.props.inputType} addonPos={this.retrieveValue("addonPos", this.state.childs.children[1].props.children.props.addonPos, this.state.currentValues)} inputValue={this.retrieveValue("inputValue", this.state.childs.children[1].props.children.props.inputValue, this.state.currentValues)} actions={true}>
                        <Button type="secondary" glyph={this.retrieveValue("glyph", this.state.childs.children[1].props.children.props.children.props.glyph, this.state.currentValues)}>{this.retrieveValue("children", this.state.childs.children[1].props.children.props.children.props.children, this.state.currentValues)}</Button>
                    </InputGroup>
                </FormItem>
            </FormGroup>
                break;
            case 'listgroup':
                componentToGenerate = 
                <ListGroup>
                <ListGroupItem>{this.retrieveValue("children", this.state.childs.children.props.children[0],this.state.currentValues)}
                <ListGroupItemActions>
                                <Button type="secondary" glyph={this.retrieveValue("glyph", this.state.childs.children.props.children[1].props.children.props.glyph, this.state.currentValues)} />
                            </ListGroupItemActions>
                </ListGroupItem>
                </ListGroup>
                break;
            case 'tile':
                if (this.state.component == "" || this.state.component == "simple"){
                    componentToGenerate = 
                    <Tile>
                        <TileContent title={this.retrieveValue("title", this.state.childs.children.props.title, this.state.currentValues)}>
                            <p>{this.retrieveValue("children", this.state.childs.children.props.children.props.children, this.state.currentValues)}</p>
                        </TileContent>
                        <TileActions>
                    ...
                    <Tile>
                        <ProductTile isButton="true">
                            ...
                            <ProductTileContent title={this.retrieveValue("title", this.state.childs.children.props.title, this.state.currentValues)}>
                                <p>{this.retrieveValue("children", this.state.childs.children.props.children.props.children, this.state.currentValues)}</p>
                            </ProductTileContent>
                        </ProductTile>
                    </Tile>;
