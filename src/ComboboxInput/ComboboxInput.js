...
import {} from '../';
import { Popover, Menu, Separator, Header, Description, Import, Properties } from '..';
                ...
                control={
                    <div className="fd-combobox-control">
                        <div className={`fd-input-group fd-input-group--after${compact ? ' fd-input-group--compact' : ''}`}>
                            <input type="text" className={`fd-input${compact ? ' fd-input--compact' : ''}`} id="" placeholder={placeholder} />
