...
export class DatePicker extends Component {
    ...
    formatDate(date) {
        ...
        if (this.props.enableRangeSelection) {
            ...
            if (
                ( !(Array.isArray(date)) ||  ! (date instanceof Date) || typeof date !== 'object') &&
        ...
        if (e.key === 'Enter') {
            ...
            if (this.props.enableRangeSelection) {
                ...
                if (
                    ...
                    if (
                        (!isNaN(firstYearRange) || !isNaN(firstDateRange) || !isNaN(firstMonthRange)) &&
                        (!isNaN(secondYearRange) || !isNaN(secondDateRange) || !isNaN(secondMonthRange)) &&
    ...
    render() {
        return (
            <div className="fd-date-picker" ref={component => (this.component = component)}>
                <div className="fd-popover">
                    ...
                    >
                        <Calendar
                            ...
                            customDate={
                                this.props.enableRangeSelection ? this.state.arrSelectedDates : this.state.selectedDate
                            }
                        />
                    </div>
                </div>
