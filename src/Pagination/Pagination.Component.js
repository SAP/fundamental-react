        ...
        <div>
            ...
            <Properties
                ...
                properties={[
                    ...
                    {
                        name: 'itemsPerPage',
                        description: 'number (default: 10) - Number of items to display on page.'
                    },
                    {
                        name: 'initialPage',
                        description: 'number (default: page 1) - Initial page to be selected.'
                    },
                    {
                        name: 'displayTotal',
                        description:
            ...
            <h2>First Page</h2>
            <Description>When the first page is active, the Back arrow should be disabled.</Description>
            <DocsTile centered>
