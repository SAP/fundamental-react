...
<ButtonGroup>  
    ...
    return (
        <div>
            ...
            <Playground component="button" schema= {[
                    {
                        attribute: 'children',
                ...
                <Button type="toolbar" glyph="filter" semantic="positive" size="compact" state="enabled">BUTTON</Button>
            </Playground>

            <h2>Playground ButtonGroup</h2>
            <Playground component="buttongroup" schema= {[
                    {
                        attribute: 'size',
                        typeOfAttribute: 'string',
                        enum: ['xs', 's', 'compact', 'l']
                ...
                <ButtonGroup>  
                    <ButtonGrouped size="s"></ButtonGrouped>
                    <ButtonGrouped size="s" glyph="pie-chart" state="default"></ButtonGrouped>
                    <ButtonGrouped size="s"></ButtonGrouped>
                </ButtonGroup>
            </Playground>
