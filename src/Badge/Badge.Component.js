...
<Button option="light" glyph="bell">
  ...
  return (
    <div>
      ...
      <Import
        module="Badge, Label, Status, Counter"
      ...
      <Properties
        ...
        properties={[
          ...
          },
          {
            name: 'notification',
            description:
              "bool - Set to 'true' to enable counter with notification. "
          }
        ]}
      />
      ...
      <h2>Pill Badge</h2>
      <Description>
        Apply <code>modifier="pill"</code> to render a pill version of the
        badge.
      </Description>
      <DocsTile centered>
      ...
      <h2>Filled Badge</h2>
      <Description>
        Apply <code>modifier="filled"</code> to render a filled version of the
        badge.
      </Description>
      <DocsTile centered>
